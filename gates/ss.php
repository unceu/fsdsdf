...
－－－－－－－－－－－－－－－－
な 𝑪𝒉𝒆𝒄𝒌𝒊𝒏𝒈 𝒚𝒐𝒖𝒓 𝒄𝒄 🔥
な 𝐆𝐫𝐚𝐛 𝐚 𝐬𝐧𝐚𝐜𝐤 𝐚𝐧𝐝 𝐰𝐚𝐢𝐭 🥐
－－－－－－－－－－－－－－－－
な 𝒄𝒉𝒆𝒄𝒌 𝒎𝒚 𝒈𝒓𝒐𝒖𝒑 @undefychatchk 💙
な 𝐂𝐡𝐞𝐜𝐤𝐞𝐝 𝐛𝐲 : $user 💻 
");
edit_message($chatId,"$upd ",$message_id_1); 
$ch = curl_init();
...
{"id":"'.$pi.'","client_secret":"'.$scrt.'","amount":2}
-----------------------------20016971038594175122050724319
...
な 𝐂𝐚𝐫𝐝 : <code>$lista</code>
な 𝐒𝐭𝐚𝐭𝐮𝐬 : 𝑨𝒑𝒑𝒓𝒐𝒗𝒆𝒅 🔥
な 𝐑𝐞𝐬𝐩𝐨𝐧𝐬𝐞 : 𝘾𝘾𝙉 𝙇𝙄𝙑𝙀 🔥
な 𝐆𝐚𝐭𝐞 : STRIPE CHARGE 1$
...
な 𝐒𝐭𝐚𝐭𝐮𝐬 : Live 🔥
な Response - CVV LIVE ✅
な GATEWAY- Stripe Auth
－－－－－－－－－－－－－－－－
𝐒𝐞𝐧𝐝 𝐬𝐜𝐫𝐞𝐞𝐧𝐬𝐡𝐨𝐭 𝐭𝐨 @balenottere
－－－－－－－－－－－－－－－－
な Credit Deducted - 1
な Proxy  - 109.xxx.xxx.189 Live! 👾
な Retries: 2 🔁
な 𝐂𝐡𝐞𝐜𝐤𝐞𝐝 𝐛𝐲 : $user 💻
『 𝗕𝗢𝗧 𝗕𝗬 - $bowner 💤 』");
